...
const documentStageReducer = <T extends string, D>(
    ...
    switch (action.type) {
        ...
        case getDocumentStages.REQUEST:
        case getDocumentStages.SUCCESS:
        case getDocumentStages.FAILURE:
            return reducerHandler(state, action, getDocumentStages as ActionHandler<"GET_DOCUMENT_STAGE">);
...
export default documentStageReducer; // Xuất reducer để sử dụng ở nơi khác