...
const paymentRquestReducer = <T extends string, D>(
    ...
    switch (action.type) {
        ...
        case getPaymentRequest.REQUEST:
        case getPaymentRequest.SUCCESS:
        case getPaymentRequest.FAILURE:
            return reducerHandler(state, action, getPaymentRequest as ActionHandler<"GET_PAYMENT_REQUEST">);
...
export default paymentRquestReducer; // Xuất reducer để sử dụng ở nơi khác