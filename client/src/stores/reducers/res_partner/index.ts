...
const resPartnerReducer = <T extends string, D>(
    ...
    switch (action.type) {
        ...
        case gerResPartner.REQUEST:
        case gerResPartner.SUCCESS:
        case gerResPartner.FAILURE:
            return reducerHandler(state, action, gerResPartner as ActionHandler<"GET_RES_PARTNER">);
...
export default resPartnerReducer; // Xuất reducer để sử dụng ở nơi khác