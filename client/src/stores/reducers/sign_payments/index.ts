...
const signPaymentsReducer = <T extends string, D>(
    ...
    switch (action.type) {
        ...
        case getSignPayments.REQUEST:
        case getSignPayments.SUCCESS:
        case getSignPayments.FAILURE:
            return reducerHandler(state, action, getSignPayments as ActionHandler<"GET_SIGN_PAYMENTS">);
...
export default signPaymentsReducer; // Xuất reducer để sử dụng ở nơi khác