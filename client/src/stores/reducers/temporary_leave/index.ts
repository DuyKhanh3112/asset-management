...
const temporaryLeaveReducer = <T extends string, D>(
    ...
    switch (action.type) {
        ...
        case getTemporaryLeaves.REQUEST:
        case getTemporaryLeaves.SUCCESS:
        case getTemporaryLeaves.FAILURE:
            return reducerHandler(state, action, getTemporaryLeaves as ActionHandler<"GET_TEMPORARY_LEAVE">);
...
export default temporaryLeaveReducer; // Xuất reducer để sử dụng ở nơi khác