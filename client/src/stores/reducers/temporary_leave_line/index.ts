...
const temporaryLeaveLineReducer = <T extends string, D>(
    ...
    switch (action.type) {
        ...
        case getTemporaryLeaveLine.REQUEST:
        case getTemporaryLeaveLine.SUCCESS:
        case getTemporaryLeaveLine.FAILURE:
            return reducerHandler(state, action, getTemporaryLeaveLine as ActionHandler<"GET_TEMPORARY_LEAVE">);
...
export default temporaryLeaveLineReducer; // Xuất reducer để sử dụng ở nơi khác