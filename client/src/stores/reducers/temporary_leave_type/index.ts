...
const temporaryLeaveTypeReducer = <T extends string, D>(
    ...
    switch (action.type) {
        ...
        case getTemporaryLeaveType.REQUEST:
        case getTemporaryLeaveType.SUCCESS:
        case getTemporaryLeaveType.FAILURE:
            return reducerHandler(state, action, getTemporaryLeaveType as ActionHandler<"GET_TEMPORARY_LEAVE_TYPE">);
...
export default temporaryLeaveTypeReducer; // Xuất reducer để sử dụng ở nơi khác