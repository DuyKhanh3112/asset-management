...
const userReducer = <T extends string, D>(
    ...
    switch (action.type) {
        ...
        case getUsers.FAILURE:
            return reducerHandler(state, action, getUsers as ActionHandler<"GET_DEPARTMENTS">);
...
export default userReducer; // Xuất reducer để sử dụng ở nơi khác